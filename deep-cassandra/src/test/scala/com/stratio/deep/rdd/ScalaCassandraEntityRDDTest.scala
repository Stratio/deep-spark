...
class ScalaCassandraEntityRDDTest extends AbstractDeepSparkContextTest {
  ...
  private var rddConfig: CassandraDeepJobConfig[DeepScalaPageEntity] = _
  private var writeConfig: CassandraDeepJobConfig[DeepScalaPageEntity] = _
...
//    };
//
//    DeepSparkContext.saveRDD(rdd, writeConfig)
//    checkSimpleTestData()
  }

  private def initWriteConfig(): CassandraDeepJobConfig[DeepScalaPageEntity] = {
  ...
  private def initReadConfig(): CassandraDeepJobConfig[DeepScalaPageEntity] = {
    rddConfig =
      CassandraConfigFactory
