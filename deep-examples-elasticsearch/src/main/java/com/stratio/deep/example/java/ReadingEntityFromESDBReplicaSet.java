 ...
 */
public final class ReadingEntityFromESDBReplicaSet {
	private static final Logger LOG = Logger.getLogger(ReadingEntityFromESDBReplicaSet.class);

    private ReadingEntityFromESDBReplicaSet() {
    }
