...
public class WrittingRddWithQueryBuilderToCassandra {
    private static final Logger LOG = Logger.getLogger(WrittingRddWithQueryBuilderToCassandra.class);
    public static List<Tuple2<String, Integer>> results;

    private WrittingRddWithQueryBuilderToCassandra() {
    }
