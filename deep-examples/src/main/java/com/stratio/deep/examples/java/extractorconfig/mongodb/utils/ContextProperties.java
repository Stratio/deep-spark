...
package com.stratio.deep.examples.java.extractorconfig.mongodb.utils;
...
public class ContextProperties {
    ...
    public ContextProperties(String[] args) {
        ...
        options.addOption(
                OptionBuilder.hasArg().withType(Integer.class).withLongOpt("mongoCqlPort").withArgName("mongo_cql_port")
                        .withDescription("mongo's cql port, defaults to 9042").create());
