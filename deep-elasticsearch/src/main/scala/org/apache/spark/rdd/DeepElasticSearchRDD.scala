 ...
 * @param config The Deep ElasticSearch configuration.
 */
@DeveloperApi
abstract class DeepElasticSearchRDD[T: ClassTag](sc: SparkContext,
  ...
  override def getPartitions: Array[Partition] = {
    val inputFormatClass: Class[org.elasticsearch.hadoop.mr.EsInputFormat[Object, LinkedMapWritable]] = classOf[org.elasticsearch.hadoop.mr.EsInputFormat[Object, LinkedMapWritable]]
  ...
  def transformElement(tuple: (Object, LinkedMapWritable)): T
  ...
  def getConf: IESDeepJobConfig[T] = confBroadcast.value
}
