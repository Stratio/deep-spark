 ...
 */
public class GenericConfigFactoryESDBTest {
    ...
    public void testDatabaseValidation() {
        IESDeepJobConfig<MessageTestEntity> djc = ESConfigFactory.createES(MessageTestEntity.class);
    ...
    public void testHostValidation() {
        ...
        IESDeepJobConfig<MessageTestEntity> djc2 = ESConfigFactory.createES(MessageTestEntity.class);
    ...
    public void testEntity() {
        ...
        IESDeepJobConfig<Cells> djcCell = ESConfigFactory.createES();
