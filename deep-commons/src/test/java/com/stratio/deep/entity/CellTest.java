...
public class CellTest {
    ...
    public void testCellInstantiationForCollections() throws UnknownHostException, NoSuchFieldException {
        ...
        Cell c1 = CassandraCell.create(te, CommonsTestEntity.class.getDeclaredField("emails"));
        ...
        Cell c2 = CassandraCell.create(te, CommonsTestEntity.class.getDeclaredField("phones"));
        ...
        Cell c3 = CassandraCell.create(te, CommonsTestEntity.class.getDeclaredField("uuid2id"));
    ...
    public void testCellInstantiation() throws UnknownHostException {
        Cell c1 = CassandraCell.create("name", "Luca");
        ...
        Cell c2 = CassandraCell.create("percent", -1.0f);
        ...
        Cell c3 = CassandraCell.create("percent", 4);
        ...
        Cell c4 = CassandraCell.create("date", testDate);
        ...
        Cell c6 = CassandraCell.create("timeMillis", testLong);
        ...
        Cell c7 = CassandraCell.create("booltype", Boolean.TRUE);
        ...
        Cell c8 = CassandraCell.create("BigDecimalType", new BigDecimal(testLong));
        ...
        Cell c9 = CassandraCell.create("Doubletype", 100.09);
        ...
        Cell c10 = CassandraCell.create("InetAddressType", testInet);
        ...
        Cell c11 = CassandraCell.create("BigIntegerType", testBigInt);
        ...
        Cell c12 = CassandraCell.create("UUIDType", testUUID);
        ...
        Cell c13 = CassandraCell.create("TimeUUIDType", testTimeUUID);
        ...
        Cell c14 = CassandraCell.create(c13, c13.getDecomposedCellValue());
        assertNotNull(c14);
        ...
        try {
            Cell c15 = CassandraCell.create(c13, new CellsTest());
            fail();
        ...
        try {
            Cell c15 = CassandraCell.create("my cell name", new CellsTest());
            fail();
        } catch (DeepInstantiationException d) {
            logger.info("correctly catched DeepInstantiationException");
        }
        ...
        try {
            Cell c15 = CassandraCell.create("my cell name", new CellsTest(), true, true);
            fail();
        } catch (DeepInstantiationException d) {
            logger.info("correctly catched DeepInstantiationException");
        }
    ...
    public void testCellWithNullValues() {
        Long testLong = System.currentTimeMillis();
        Cell c8 = CassandraCell.create("BigDecimalType", new BigDecimal(testLong));
        Cell c16 = CassandraCell.create("no_value_cell");
    ...
    public void testCellInstantiationWithByteBuffer() {
        ...
        Cell metadata = CassandraCell.create("id", DataType.text(), false, true);

        Cell c = CassandraCell.create(metadata, bb);
        ...
        Cell nullCell = CassandraCell.create("nullCell", DataType.text(), false, true);
    ...
    public void testEquality() {
        ...
        Cell c = CassandraCell.create("id", id, true, false);

        assertFalse(c.equals(new Integer(1)));
        assertTrue(c.equals(c));
        assertFalse(c.equals(CassandraCell.create("id", id, false, false)));
        assertFalse(c.equals(CassandraCell.create("id", id, true, true)));
        assertTrue(c.equals(CassandraCell.create("id", id, true, false)));
    }

    @Test
    public void testNullCellEquality() {

        Cell nullCell1 = CassandraCell.create("nullCell1");
        Cell nullCell2 = CassandraCell.create("nullCell1");
