 ...
 */
public abstract class ExtractorEntityTest<S extends BaseConfig<BookEntity>> extends ExtractorTest<BookEntity, S> {
    ...
    public void testDataSet() {
        ...
        try {
            ...
            //      tests subDocuments
            assertEquals( originBook.getMetadataEntity().getAuthor() , book.getMetadataEntity().getAuthor());

            //      tests List<subDocuments>
            List<CantoEntity> listCantos = originBook.getCantoEntities();
