...
public class MongoEntityExtractorTest extends ExtractorTest implements Serializable {

    private static final Logger LOG = LoggerFactory.getLogger(MongoEntityExtractorTest.class);

    public MongoEntityExtractorTest() {
        super(MongoEntityExtractor.class, "localhost:27890", null);
    }

    public void testRead() {
        DeepSparkContext context = new DeepSparkContext("local", "deepSparkContextTest");

        ExtractorConfig<MessageTestEntity> inputConfigEntity = getReadExtractorConfig(MessageTestEntity.class);
    ...
    public void testWrite() {
        ...
        ExtractorConfig<MessageTestEntity> outputConfigEntity = getWriteExtractorConfig(MessageTestEntity.class);
