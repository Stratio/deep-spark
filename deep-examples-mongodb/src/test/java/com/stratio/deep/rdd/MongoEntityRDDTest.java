...
//        inputConfigEntity.putValue(ExtractorConstants.HOST,hostConcat).putValue(ExtractorConstants.DATABASE, DATABASE).putValue(ExtractorConstants.COLLECTION,COLLECTION_OUTPUT);
//
//
//
//
...
//        inputConfigEntity.putValue(ExtractorConstants.HOST,hostConcat).putValue(ExtractorConstants.DATABASE, "book").putValue(ExtractorConstants.COLLECTION,"output");
//
//
//        context.saveRDD((RDD<WordCount>) outputRDD.rdd(), outputConfigEntity);
//
