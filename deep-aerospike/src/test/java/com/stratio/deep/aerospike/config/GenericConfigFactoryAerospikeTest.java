...
public class GenericConfigFactoryAerospikeTest {
    ...
    private static final String SET_TEST = "set";
    ...
    private static final String BIN_TEST = "bin";
    ...
    public void testDatabaseValidation() {
        ...
        djc.host(HOST_TEST).bin(BIN_TEST);
...
//        MongoDeepJobConfig<MessageTestEntity> djc = MongoConfigFactory.createMongoDB(MessageTestEntity.class);
//
...
//
//        MongoDeepJobConfig<MessageTestEntity> djc2 = MongoConfigFactory.createMongoDB(MessageTestEntity.class);
//
