...
import com.stratio.deep.aerospike.extractor.AerospikeNativeCellExtractor;
...
/**
 * Test for AerospikeNativeCellExtractor
 */
@Test(groups = { "AerospikeNativeCellExtractorFT", "FunctionalTests" }, dependsOnGroups = { "AerospikeJavaRDDFT" })
public class AerospikeNativeCellExtractorFT extends ExtractorCellTest {

    private static final Logger LOG = LoggerFactory.getLogger(AerospikeNativeCellExtractorFT.class);

    public AerospikeNativeCellExtractorFT() {
        super(AerospikeNativeCellExtractor.class, AerospikeJavaRDDFT.HOST, AerospikeJavaRDDFT.PORT, true);
    }
