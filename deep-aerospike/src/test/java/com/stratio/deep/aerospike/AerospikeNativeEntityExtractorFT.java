...
import com.stratio.deep.aerospike.extractor.AerospikeNativeEntityExtractor;
...
/**
 * AerospikeNativeEntityExtractor functional tests.
 */
@Test(groups = { "AerospikeNativeEntityExtractorFT", "FunctionalTests" }, dependsOnGroups = { "AerospikeJavaRDDFT" })
public class AerospikeNativeEntityExtractorFT extends ExtractorEntityTest {

    private static final Logger LOG = LoggerFactory.getLogger(AerospikeEntityExtractorFT.class);

    public AerospikeNativeEntityExtractorFT() {
        super(AerospikeNativeEntityExtractor.class, AerospikeJavaRDDFT.HOST, AerospikeJavaRDDFT.PORT, false);
    }
    ...
    public void testInputColumns() {
        ...
        try {
            ...
            inputConfigEntity.putValue(ExtractorConstants.HOST, AerospikeJavaRDDFT.HOST)
                    ...
                    .putValue(ExtractorConstants.INPUT_COLUMNS, new String[] { "id" });
            ...
            inputConfigEntity2.putValue(ExtractorConstants.HOST, AerospikeJavaRDDFT.HOST)
                    ...
                    .putValue(ExtractorConstants.NAMESPACE, AerospikeJavaRDDFT.NAMESPACE_ENTITY)
                    .putValue(ExtractorConstants.SET, "input")
                    .putValue(ExtractorConstants.INPUT_COLUMNS, new String[] { "message" });
    ...
    protected void testFilterEQ() {
        ...
        try {
            ...
            com.stratio.deep.commons.filter.Filter equalFilter = new com.stratio.deep.commons.filter.Filter("number",
                    FilterType.EQ, 3L);
            com.stratio.deep.commons.filter.Filter ltFilter = new com.stratio.deep.commons.filter.Filter("number",
                    FilterType.LT, 4L);
            com.stratio.deep.commons.filter.Filter gtFilter = new com.stratio.deep.commons.filter.Filter("number",
                    FilterType.GT, 5L);
            com.stratio.deep.commons.filter.Filter lteFilter = new com.stratio.deep.commons.filter.Filter("number",
                    FilterType.LTE, 3L);
            com.stratio.deep.commons.filter.Filter gteFilter = new com.stratio.deep.commons.filter.Filter("number",
                    FilterType.GTE, 4L);
            com.stratio.deep.commons.filter.Filter equalFilter2 = new com.stratio.deep.commons.filter.Filter("number",
                    FilterType.EQ, 4L);
            ...
            try {
                filters = new com.stratio.deep.commons.filter.Filter[] {
                        new com.stratio.deep.commons.filter.Filter("number", FilterType.NEQ, "invalid") };
                ExtractorConfig inputConfigEntity = getFilterConfig(filters);
            } catch (UnsupportedOperationException e) {
            ...
            try {
                com.stratio.deep.commons.filter.Filter invalidFilter = new com.stratio.deep.commons.filter.Filter(
                        "number", FilterType.LT, "invalid");
            ...
            inputConfigEntity.putValue(ExtractorConstants.HOST, AerospikeJavaRDDFT.HOST)
                    ...
                    .putValue(ExtractorConstants.NAMESPACE, AerospikeJavaRDDFT.NAMESPACE_ENTITY)
                    .putValue(ExtractorConstants.SET, "input")
                    .putValue(ExtractorConstants.FILTER_QUERY,
                            new com.stratio.deep.commons.filter.Filter[] { equalFilter });
            inputConfigEntity.setExtractorImplClass(AerospikeEntityExtractor.class);
            ...
            inputConfigEntity2.putValue(ExtractorConstants.HOST, AerospikeJavaRDDFT.HOST)
                    ...
                    .putValue(ExtractorConstants.SET, "input")
                    .putValue(ExtractorConstants.FILTER_QUERY,
                            new com.stratio.deep.commons.filter.Filter[] { ltFilter });
            inputConfigEntity2.setExtractorImplClass(AerospikeEntityExtractor.class);
            ...
            inputConfigEntity3.putValue(ExtractorConstants.HOST, AerospikeJavaRDDFT.HOST)
                    ...
                    .putValue(ExtractorConstants.SET, "input")
                    .putValue(ExtractorConstants.FILTER_QUERY,
                            new com.stratio.deep.commons.filter.Filter[] { gtFilter });
            ...
            inputConfigEntity4.putValue(ExtractorConstants.HOST, AerospikeJavaRDDFT.HOST)
                    ...
                    .putValue(ExtractorConstants.SET, "input")
                    .putValue(ExtractorConstants.FILTER_QUERY,
                            new com.stratio.deep.commons.filter.Filter[] { lteFilter });
            ...
            inputConfigEntity5.putValue(ExtractorConstants.HOST, AerospikeJavaRDDFT.HOST)
                    ...
                    .putValue(ExtractorConstants.SET, "input")
                    .putValue(ExtractorConstants.FILTER_QUERY,
                            new com.stratio.deep.commons.filter.Filter[] { gteFilter });
